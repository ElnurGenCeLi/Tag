...
async def start(event):
  await event.reply("**KaronaTaggerBot**\n ilə qrupunuzdakı bütün üzvləri tag edə bilərəm \nƏmrlər üçün =======> /help yazın**",
                    buttons=(
                   
		      [Button.url('Məni qrupa əlavə et ➕', 'https://t.me/KaronaTaggerBot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/SecretMMC')],
                      [Button.url('Rəsmi Kanal📣', 'https://t.me/SecretMMC')],
		      [Button.url('İnkişaf etdirici👨🏻‍💻', 'https://t.me/o2o_GenCeLi')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**KaronaTaggerBot Əmrləri**\n\n**/tag - 5-li tag edər**\n\n**/etag - Emoji ilə tag edər**\n\n**/tektag - Tək-tək tag edər**\n\n**/admins - Adminləri tək-tək tag edər**\n\n**/start - Botu başladır**"
...
async def help(event):
  helptext = "**Çox funksiyalı tag botunu tapmağa çalışan qrup sahibləri @KaronaTaggerBot Sizə Görə:\n\n📌 5-li tag\n📌 Emoji tag\n📌 Təkli tag\n📌 Yalnız adminləri tag etmək\n📌\n\n Belə çox funksiyalı @KaronaTaggerBot -u Qrupunuza əlavə edib bota idarəçilik verərək asanlıqla tag prosesi başlada bilərsiniz.**"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu qrupa əlavə et ➕', 'https://t.me/KaronaTaggerBot?startgroup=a')],
                    ),
                    link_preview=False
                   )
